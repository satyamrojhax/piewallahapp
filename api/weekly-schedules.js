/**
 * Vercel Serverless Function - Weekly Schedules API Proxy
 * This handles the weekly-schedules endpoint with proper authentication and CORS
 */
...
export default async function handler(req, res) {
    ...
    try {
        ...
        const { batchId, batchSubjectId = '', startDate, endDate, page = '1' } = req.query;
        ...
        const targetUrl = `${AUTH_CONFIG.BASE_URL_V1}/batches/${batchId}/weekly-schedules?batchId=${batchId}&batchSubjectId=${batchSubjectId}&startDate=${startDate}&endDate=${endDate}&page=${page}`;
